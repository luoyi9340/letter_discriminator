...
from model.DenseNet.part import DenseBlockLayer, TransitionLayer
from math import ceil, floor


#    DenseNet-121
class DenseNet_121(AModel):
    '''
        ---------- 输入 ----------
        输入：[100 * 100 * 1]
        ---------- layer1 ----------
    ...
    def __init__(self, 
        ...
        super(DenseNet_121, self).__init__(name='DenseNet_121', learning_rate=learning_rate)
        pass
    ...
    def assembling(self, net):
        ...
        net.add(DenseBlockLayer(name='dense_block_2',
                                growth_rate=self._growth_rate,
                                num=6,
                                input_shape=l2_d_in,
        ...
        net.add(TransitionLayer(name='transition_2',
        ...
        net.add(DenseBlockLayer(name='dense_block_3',
                                growth_rate=self._growth_rate,
                                num=12,
                                input_shape=l3_d_in,
        ...
        net.add(TransitionLayer(name='transition_3',
                                compression_rate=compression_rate,
                                input_shape=l3_t_in,
        ...
        net.add(DenseBlockLayer(name='dense_block_4',
                                growth_rate=self._growth_rate,
                                num=24,
                                input_shape=l4_d_in,
        ...
        net.add(TransitionLayer(name='transition_4',
                                compression_rate=compression_rate,
                                input_shape=l4_t_in,
        ...
        net.add(DenseBlockLayer(name='dense_block_5',
                                growth_rate=self._growth_rate,
                                num=16,
                                input_shape=l5_d_in,
