...
from utils.Conf import ROOT_PATH
from utils.Conf import LOGS
...
def init_root_logger():
    ...
    #    root log输出位置
    root_log_path = ROOT_PATH + "/logs/root.log"
...
def init_logger_by_name(log_name):
    ...
    if (not log_path.startswith("/")): log_path = ROOT_PATH + "/" + log_path
